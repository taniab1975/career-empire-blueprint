...
Publication location confirmed by Tania during Batch 1 close-out: GitHub Pages is the current public reader, including the Visuals topic URL. The editable authority remains the same canonical local checkout. Old GPT/Sites Blueprint and Design Atlas links retain historical/source roles only.
