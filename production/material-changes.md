...
- **status:** Verified candidate; source-bound publication underway
...
- **deployment:** Authorised bounded EST release before resuming the separate campus review; public verification pending.
